...
(cl:defmethod cl:initialize-instance :after ((m <WheelPower>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelPower)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name am_driver-msg:<WheelPower> is deprecated: use am_driver-msg:WheelPower instead.")))
