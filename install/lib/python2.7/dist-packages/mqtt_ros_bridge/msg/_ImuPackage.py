...
class ImuPackage(genpy.Message):
  _md5sum = "62e531d68c2a751bac021327d713af95"
  _type = "mqtt_ros_bridge/ImuPackage"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """mqtt_ros_bridge/Vector3Time[] linear_acceleration
...
uint64 data"""
  ...
  _slot_types = ['mqtt_ros_bridge/Vector3Time[]','mqtt_ros_bridge/Vector3Time[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.linear_acceleration:
        ...
        _v2 = val1.time
        buff.write(_get_struct_Q().pack(_v2.data))
      ...
      for val1 in self.angular_velocity:
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v4 = val1.time
        buff.write(_get_struct_Q().pack(_v4.data))
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.linear_acceleration:
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v10 = val1.time
        buff.write(_get_struct_Q().pack(_v10.data))
      length = len(self.angular_velocity)
      buff.write(_struct_I.pack(length))
      for val1 in self.angular_velocity:
        _v11 = val1.vector
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v12 = val1.time
        buff.write(_get_struct_Q().pack(_v12.data))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
