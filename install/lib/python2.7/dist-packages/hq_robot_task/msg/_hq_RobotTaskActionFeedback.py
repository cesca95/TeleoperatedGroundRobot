...
"""autogenerated by genpy from hq_robot_task/hq_RobotTaskActionFeedback.msg. Do not edit."""
import sys
...
class hq_RobotTaskActionFeedback(genpy.Message):
  _md5sum = "134e954fabb76f2141ba1da062557ee3"
  _type = "hq_robot_task/hq_RobotTaskActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hq_robot_task/hq_RobotTaskFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(hq_RobotTaskActionFeedback, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.feedback.complete))
